...
const StatsCards = ({ dashboardStats }: StatsCardsProps) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
      <div className="bg-gradient-to-br from-teal-500/20 to-teal-600/10 border-teal-500/30 rounded-lg border p-3">
        <div className="pb-1">
          <h3 className="text-white flex items-center text-xs font-semibold">
            <svg className="h-3 w-3 mr-1 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/10 border-blue-500/30 rounded-lg border p-3">
        <div className="pb-1">
          <h3 className="text-white flex items-center text-xs font-semibold">
